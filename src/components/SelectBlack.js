...
const onHandlePawnFirstMove =  (data,handler,state,cells) => {
...
const onHandleRookFirstMove = (data,handler,state,cells) => {
...
const onHandleKnightFirstMove = (data,handler,state,cells) => {
 ...
 const onHandleBishopFirstMove = (data,handler,state,cells) => {
 ...
 const onHandleQueenFirstMove = (data,handler,state,cells) => {
...
const onHandleKingFirstMove = (data,handler,state,cells) => {
     let prevQueenCell = data.cell_name;
     let selectedCell = {
          'left': [],
          'right': [],
